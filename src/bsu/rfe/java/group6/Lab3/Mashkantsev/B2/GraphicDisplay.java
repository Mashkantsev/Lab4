package bsu.rfe.java.group6.Lab3.Mashkantsev.B2;
...
public class GraphicDisplay extends JPanel {
    ...
    private BasicStroke SegmentationStroke;
    ...
    public GraphicDisplay(){
        ...
        SegmentationStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, null, 0.0f);
    ...
    public void paintComponent(Graphics g){
        ...
        if(scale==scaleX) {
            /* Если за основу был взят масштаб по оси X, значит по оси Y делений меньше, т.е. подлежащий отображению диапазон по Y
